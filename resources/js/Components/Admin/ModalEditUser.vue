...
const handleSend = () => {
    form.clearErrors();
    const path = route("admin.tags.update", {
        tag: props.id,
    });
    form.transform((data) => ({
        ...data,
    ...
    form.post(path, {
        ...
        onError: () => {
            toast("No se pudo editar un tag", {
                autoClose: 1000,
                position: "top-right",
                type: "error",
            });
...
<template>
    <Teleport to="body">
        ...
        >
            ...
            >
                <header
                    class="bg-primary flex justify-start items-center gap-2 p-3 w-full rounded-t-md"
                >
                ...
                <div class="rounded-b-md w-full px-4 py-5 bg-white h-[160px]">
                    ...
                    >
                        ...
                        <TertiaryButton
                            ...
                            type="button"
                            :class="
                                form.processing ? 'bg-gray-200' : 'bg-green-600'
                            "
                        >
